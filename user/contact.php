...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <main>
            <!-- breadcrumb-area -->
            <section class="breadcrumb-area breadcrumb-bg" data-background="./assets/images/breadcrumb_bg.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                            <div class="contact-form-wrap">
                                ...
                                <div class="contact-form">
                                    <form id="contact-form" action="https://formspree.io/f/mqkovllq" method="POST">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" id="full-name" nama="full-name" placeholder="Your Name *">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="email" id="email" nama="email" placeholder="Your  Email *">
                                            </div>
                                        </div>
                                        <input type="text" id="subject" nama="subject" placeholder="Subject *">
                                        <textarea name="message" id="message" nama="message" placeholder="Type Your Message..."></textarea>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            ...
                            <div class="contact-info-wrap">
                                <p><span>Find our location :</span></p>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.2236132034245!2d110.42756727418931!3d-7.76609527702705!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a5925d6d2c2a9%3A0x651d10f43e7c6840!2seduwork.id!5e0!3m2!1sid!2sid!4v1686028924813!5m2!1sid!2sid" width="100%" height="290" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
