                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <?= $data['nama_aktor']?>
                        <!-- <?php
                        $data_aktor = mysqli_query($conn, "SELECT * FROM aktor") or die (mysqli_error($conn));
                      ...
                      <td width="150px" class="text-center">
                          ...
                          <a href="proses_delete.php?id_daktor=<?= $data['id_daktor']?>" onclick="return confirm('Yakin Hapus data?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                      </td>
                      </tr>
                      <?php $no++; } ?>
                      <?php } ?>
