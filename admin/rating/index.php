<?php
include "../../config.php";
$query = mysqli_query($conn, "SELECT * FROM rating JOIN film ON rating.id_film=film.id_film JOIN login ON rating.username=login.username");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-12">
              <div class="card">
                <!-- <div class="card-header">
                  <button type="button" class="btn bg-gradient-success">Tambah Data</button>
                </div> -->
                <!-- /.card-header -->
                <div class="card-body">
                      ...
                      <?php if (mysqli_num_rows($query) > 0) { ?>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?= substr($data['komentar'], 0, 50) ?></td>
                            <td><?= $data['judul_film'] ?></td>
                            <td><?= $data['nama'] ?></td>
                            <td width="120px" class="text-center">
                              <a href="proses_delete.php?id_rating=<?= $data['id_rating'] ?>" onclick="return confirm('Yakin Hapus data?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                            </td>
                          </tr>
                        <?php $no++;
                        } ?>
