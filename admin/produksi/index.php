<?php
  session_start();
  include "../../config.php";
  $query = mysqli_query($conn, "SELECT * FROM film JOIN detail_sutradara ON film.id_film=detail_sutradara.id_film JOIN sutradara ON sutradara.id_sutradara=detail_sutradara.id_sutradara");
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        ?>
                          <tr>
                            ...
                            <td width="150px" class="text-center">
                              ...
                              <a href="proses_delete.php?id_dsutradara=<?= $data['id_dsutradara'] ?>" onclick="return confirm('Yakin Hapus data?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                            </td>
                          </tr>
                          <?php $no++;
                        } ?>
