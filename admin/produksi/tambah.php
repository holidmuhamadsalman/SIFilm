<?php
    include "../../config.php";
    $query = mysqli_query($conn, "SELECT * FROM detail_sutradara");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Data Produksi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <?php
                    $query = "SELECT * FROM sutradara ORDER BY nama_sutradara ASC";
                    $query_run = mysqli_query($conn, $query);
                    if(mysqli_num_rows($query_run) > 0){
                      foreach($query_run as $row){
                        echo $row['nama_sutradara'];?>
