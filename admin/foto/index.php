...
<div class="wrapper">
                ...
                <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $data['id_foto'] ?>"><i class="far fa-edit"></i></a>
                          <a href="proses_delete.php?id_foto=<?php echo $data['id_foto']; ?>" onclick="return confirm('Yakin Hapus data?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                      </td>
                      <!-- Start Modal Edit -->
                      <div class="modal fade bg-dark" id="modalEdit<?=$data["id_foto"]?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="modalEditLabel">Edit Data foto</h1>
  ...
  <div class="modal fade bg-dark" id="modalTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="modalTambahLabel">Tambah Data foto</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="add_edit.php" method="POST">
          <div class="modal-body">
                ...
                <select class="form-control select2" style="width: 100%;" name="role">
                  <?php
                    ...
                    while($film = mysqli_fetch_array($data_film)) {
                      echo '<option value="' .$film['id_film']. '">' .$film['nama_film'].'</option>';   
                    } ?>
                  </select>
              </div>
            </div>
