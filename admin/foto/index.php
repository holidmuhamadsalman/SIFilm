<?php
  include "../../config.php";
  $query = mysqli_query($conn, "SELECT * FROM foto JOIN film ON foto.id_film=film.id_film");
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="hold-transition sidebar-mini layout-fixed dark-mode">
                  ...
                  <table id="fotoTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><img src="../../include/img-db/<?= $data['foto'];?>" style="height: 50px;"></td>
                        <td><?= $data['status']?></td>
                        <td><?= $data['judul_film']?></td>
                        <td width="150px" class="text-center">
                          <a href="edit.php?id_foto=<?= $data['id_foto']?>" class="btn btn-primary"><i class="far fa-edit"></i></a>
                          <a href="proses_delete.php?id_foto=<?= $data['id_foto']?>" onclick="return confirm('Yakin Hapus data?')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                        </td>
                      </tr>
                      <?php $no++; endwhile;?>
                      <?php }?>
  ...
  $(function () {
    ...
    }).buttons().container().appendTo('#fotoTable_wrapper .col-md-6:eq(0)');
  });
  </script>
</body>
